 ...
 * @author Scott Long
 * @version 1.0
 * This class picks the roll and determines the winner
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick this is to determine of the pick is valid
     * @return This returns false if the pick is null
     */
    public static boolean isValidPick(String pick) {
        ...
        /**
         * @return this returns rock, paper, scissors, lizard, spock
         */
        pick = pick.trim();
    ...
    /**
     * this class generates the pick based
     * @return pick - this is the generated pick
     */
     ...
     * @param h_pick this is the human pick
     * @return this returns if the computer won the game
     */
